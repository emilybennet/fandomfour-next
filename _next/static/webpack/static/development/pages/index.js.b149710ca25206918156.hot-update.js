...
})(["align-content:center;align-items:center;background:url(\"/static/karen-pattern.webp\") repeat,radial-gradient(60vw at 50% 56.73%,#4fb0aa 0%,#334d90 100%);clip-path:polygon(0 0,100% 0,100% 100%,0 calc(100% - 4vw));display:grid;font-size:1.5em;grid-template-columns:1fr;grid-template-rows:1fr;justify-items:center;overflow:hidden;position:relative;text-align:center;z-index:400;.no-webp &{background:url(\"/static/karen-pattern.png\") repeat,radial-gradient(60vw at 50% 56.73%,#4fb0aa 0%,#334d90 100%);}svg{grid-column:1 / auto;grid-row:1 / auto;height:40em;mix-blend-mode:overlay;opacity:0.2;}polygon{fill:white;}"]);
...
})(["color:", ";display:block;font-weight:600;letter-spacing:0.09em;text-transform:uppercase;"], function (props) {
...
//# sourceMappingURL=index.js.b149710ca25206918156.hot-update.js.map