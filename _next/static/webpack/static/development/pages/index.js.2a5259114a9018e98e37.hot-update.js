...
})(["align-items:center;background:url(\"/static/mosaic-header.webp\") ", " center center;background-size:contain;clip-path:polygon(0 0,100% calc(0 + 4vw),100% 100%,0 100%);color:", ";display:flex;flex-direction:column;justify-content:center;margin-bottom:-80px;padding:200px 15px;position:relative;text-align:center;z-index:500;"], function (props) {
...
//# sourceMappingURL=index.js.2a5259114a9018e98e37.hot-update.js.map