...
})(["align-items:center;background:url(\"/static/karen-pattern.webp\") repeat,#573484;clip-path:polygon(0 0,100% 0,100% 100%,0 calc(100% - 4vw));display:grid;grid-template-columns:1fr;grid-template-rows:1fr;justify-content:center;max-height:800px;overflow:hidden;padding:200px 15px;position:relative;z-index:400;.no-webp &{background:url(\"/static/karen-pattern.png\") repeat,#573484;}svg{height:1000px;mix-blend-mode:overlay;opacity:0.5;}polygon{fill:white;}"]);
...
//# sourceMappingURL=index.js.356860b561a02b8b2ba7.hot-update.js.map