...
})(["display:flex;flex-direction:row;@media (max-width:525px){flex-direction:column;}"]);
...
})(["align-items:center;cursor:pointer;font-size:0.9em;display:flex;height:35px;justify-content:center;letter-spacing:0.1em;text-align:center;text-transform:uppercase;width:", "px;"], tabWidth);
...
})(["height:2px;width:", "px;background:", ";transition:all 0.15s ease-in-out;"], tabWidth, function (props) {
...
//# sourceMappingURL=index.js.b2f448e4a9848ea061c0.hot-update.js.map