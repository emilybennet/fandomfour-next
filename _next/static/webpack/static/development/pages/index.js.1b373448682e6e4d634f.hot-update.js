...
})(["align-items:center;background:url(\"/static/karen-pattern.webp\") repeat,#573484;clip-path:polygon(0 0,100% 0,100% 100%,0 calc(100% - 4vw));display:flex;justify-content:center;max-height:800px;overflow:hidden;padding:200px 15px;position:relative;z-index:400;.no-webp &{background:url(\"/static/karen-pattern.png\") repeat,#573484;}svg{animation:", " 200s linear infinite;height:1000px;mix-blend-mode:opacity;opacity:0.5;}polygon{fill:white;}"], rotate);
...
//# sourceMappingURL=index.js.1b373448682e6e4d634f.hot-update.js.map