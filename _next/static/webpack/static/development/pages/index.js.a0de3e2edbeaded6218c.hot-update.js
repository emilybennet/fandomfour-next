...
})(["align-content:center;align-items:center;background:url(\"/static/karen-pattern.webp\") repeat,#573484;clip-path:polygon(0 0,100% 0,100% 100%,0 calc(100% - 4vw));display:grid;font-size:2em;grid-template-columns:1fr;grid-template-rows:1fr;justify-items:center;max-height:800px;overflow:hidden;padding:200px 15px;position:relative;text-align:center;z-index:400;.no-webp &{background:url(\"/static/karen-pattern.png\") repeat,#573484;}svg{grid-column:1 / auto;grid-row:1 / auto;height:1000px;mix-blend-mode:overlay;opacity:0.5;}polygon{fill:white;}"]);
...
//# sourceMappingURL=index.js.a0de3e2edbeaded6218c.hot-update.js.map