...
})(["align-items:center;background:url(\"/static/karen-pattern.webp\") repeat,radial-gradient(60vw at 50% 56.73%,#b28ce4 0%,#573484 100%);clip-path:polygon(0 0,100% 0,100% 100%,0 calc(100% - 4vw));display:flex;justify-content:center;max-height:800px;overflow:hidden;padding:200px 15px;position:relative;z-index:400;.no-webp &{background:url(\"/static/karen-pattern.png\") repeat,radial-gradient(60vw at 50% 56.73%,#b28ce4 0%,#573484 100%);}svg{height:1000px;opacity:0.2;animation:", " 200s linear infinite;}polygon{fill:white;}"], rotate);
...
//# sourceMappingURL=index.js.c46403a19577f950d12b.hot-update.js.map