...
})(["font-family ", ";font-size:1.11em;line-height:1.8;margin:20px 50px 40px;@media (max-width:450px){margin:20px 25px 40px;}"], function (props) {
  return props.theme.poppins;
});
...
})(["display:grid;color:", ";font-size:0.83em;grid-template-columns:120px 1fr;grid-gap:20px 0;margin:0 50px;@media (max-width:450px){margin:0 25px;}"], function (props) {
  return props.theme.white;
});
...
//# sourceMappingURL=index.js.fa3e1f9239b80f950268.hot-update.js.map