...
})(["align-items:center;background:url(\"/static/mosaic-header.webp\") ", " center center;background-size:contain;clip-path:polygon(0 calc(0% + 4vw),100% 0,100% 100%,0 100%);color:", ";display:flex;flex-direction:column;justify-content:center;margin-bottom:-80px;padding:200px 15px;position:relative;text-align:center;z-index:500;"], function (props) {
...
//# sourceMappingURL=index.js.ab6d8e8966857acceffc.hot-update.js.map