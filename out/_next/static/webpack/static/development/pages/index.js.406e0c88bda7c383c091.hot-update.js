...
})(["align-items:center;background:url(\"/static/karen-pattern.webp\") repeat,#573484;clip-path:polygon(0 0,100% 0,100% 100%,0 calc(100% - 4vw));display:flex;justify-content:center;max-height:800px;overflow:hidden;padding:200px 15px;position:relative;z-index:400;.no-webp &{background:url(\"/static/karen-pattern.png\") repeat,#573484;}svg{height:1000px;opacity:0.2;animation:", " 200s linear infinite;}polygon{fill:white;}"], rotate);
...
//# sourceMappingURL=index.js.406e0c88bda7c383c091.hot-update.js.map