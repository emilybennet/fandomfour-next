...
})(["align-content:center;align-items:center;background:url(\"/static/karen-pattern.webp\") repeat,radial-gradient(60vw at 50% 56.73%,#4fb0aa 0%,#334d90 100%);clip-path:polygon(0 0,100% 0,100% 100%,0 calc(100% - 4vw));display:grid;font-size:1.5em;grid-template-columns:1fr;grid-template-rows:1fr;justify-items:center;max-height:800px;overflow:hidden;padding:200px 15px;position:relative;text-align:center;z-index:400;.no-webp &{background:url(\"/static/karen-pattern.png\") repeat,radial-gradient(60vw at 50% 56.73%,#4fb0aa 0%,#334d90 100%);}svg{grid-column:1 / auto;grid-row:1 / auto;height:1000px;mix-blend-mode:overlay;opacity:0.5;}polygon{fill:white;}"]);
...
//# sourceMappingURL=index.js.35048c1df567c58bd37e.hot-update.js.map